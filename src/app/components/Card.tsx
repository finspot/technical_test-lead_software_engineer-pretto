...
export const Card = ({
  ...
  >
    <p className="mb-4 tracking-wider leading-6 uppercase">{headline}</p>
    {/*
      ...
      */}
    <h2 className="mb-6 text-[32px] font-black tracking-[-0.02em] leading-10">
      {title}
    </h2>
    <p className="flex-1 leading-6">{content}</p>
    <div className="flex justify-end">
      <a
        className="group flex justify-center items-center w-16 h-16 bg-accent1 hover:bg-accent1-hover rounded-lg transition ease-out"
        href={href}
        title={title}
      >
